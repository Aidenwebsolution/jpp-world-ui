function CGame(oData, oCategory) {
    ...
    this.unload = function () {
        ...
        s_oStage.removeEventListener("pressup", this._onStageRelease);
        s_oStage.removeEventListener("pressmove", this._onPressMove);
    ...
    this.onCellSelected = function (oCellSelected) {
        if (_bNoCellSelected) {
            ...
            s_oStage.addEventListener("pressmove", this._onPressMove);
        }
    };
    ...
    this._onPressMove = function (evt) {
        s_oGame.lineDrawing(evt.stageX - _oContainerGrid.x, evt.stageY - _oContainerGrid.y);
        ...
        if (_aLineDrawing[_aWrittenWords.length] !== null) {
            ...
            iCurStageX = evt.stageX;
            iCurStageY = evt.stageY;
        }


        for (var i = 0; i < _iRow; i++) {
            for (var j = 0; j < _iCol; j++) {
                s_oGame.dirByMouse(evt.stageX, evt.stageY, i, j);
    ...
    this._onStageRelease = function () {
        ...
        s_oStage.removeEventListener("pressmove", s_oGame._onPressMove);
